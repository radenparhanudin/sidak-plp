            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex">
                        <h5 class="m-0 align-self-center"><i class="fas fa-users mr-2"></i>Absensi Tim Sidak</h5>
                    </div>
...
@include('components.modal-post',[
    ...
    'modalBody' => view('absensi::tim-sidak.form-post'),
])
@endsection
...
<script>
    $(document).ready(function(){
        let dataTable = $('#dataTable').DataTable({
            ajax: "{{ route('absensi.tim-sidak.datatable') }}",
            columns: [
